export function productCardTemplate(item, id) {
  return `
      ...
      <div class="product-item__content">
        ...
        >
          <div class="product-item__price text-xs text-blue-600 my-3">
            Price: <span class="font-bold text-xl">${item.price}$</span>
          </div>
          <div class="">
          <button
            class="btn delete bg-red-800 opacity-90 hover:opacity-100 text-white py-2 px-5 rounded"
          >
